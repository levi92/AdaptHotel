<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Passo_7.aspx.cs" Inherits="AdaptHotel.views.Setup.Passo_7" %>
        ...
        <div class="col s12">
            <div class="card hoverable">
                ...
                <div class="card-action">
                    <a href="../Login.aspx">Acessar Sistema</a>
                </div>
            </div>
        </div>
    </div>
