<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Recepcionista.Master" CodeBehind="Dashboard_Recepcionista.aspx.cs" Inherits="AdaptHotel.views.Recepcionista.Dashboard_Recepcionista" %>
                    ...
                    <div class="card-content" style="padding:1px; max-height: 87%; overflow-y: scroll;">
                        <ul class="collection" style="margin-top: -1px;">
                            <% foreach (var reserva in lista_reservas)
                                { %>
                            <a class="collection-item avatar waves-effect waves" href="../Recepcionista/Gerenciar_Reservas.aspx?id=<%= reserva.Hospede.Nome%>">
                                <div style="padding-top:5%;">
                                    <img src="../../images/quarto-1.jpg" alt="" class="circle">
