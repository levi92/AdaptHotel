...
public class Hospede : Pessoa
{
    ...
    public Hospede(string nome, string telefone, string email, string cpf, char sexo, DateTime dataNascimento, int codPessoa, Endereco end, string placaCarro, string cidadeOrigem, int codHospede, string senha = null): base (nome, telefone, email, cpf, sexo, dataNascimento, codPessoa, end, senha)
	{
